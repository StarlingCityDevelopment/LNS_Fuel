if not lib.checkDependency("ox_lib", "3.22.0", true) then
	return
end

if not lib.checkDependency("ox_inventory", "2.30.0", true) then
	return
end
...
return {
	...
	-- UI Accent Colors
	theme = {
		primary = "#ff0000", -- Light Blue accent color
		primaryDark = "#b30000", -- Darker variant for hovers
